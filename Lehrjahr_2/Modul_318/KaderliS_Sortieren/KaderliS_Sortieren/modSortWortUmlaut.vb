...
Module modSortWortUmlaut

    'Bubblesort
    Public Sub bubbleWortUmlaut(ByRef Wort() As String)
    ...
    'Ripplesort
    Public Sub rippleWortUmlaut(ByRef Wort() As String)
    ...
    'Quicksort
    Public Sub quickWortUmlaut(ByRef Wort() As String, ByVal intStart As Integer, ByVal intEnd As Integer)
        ...
        Loop Until i > j
        If intStart < j Then
            quickWortUmlaut(Wort, intStart, j)
        End If
        If i < intEnd Then
            quickWortUmlaut(Wort, i, intEnd)
        End If
    End Sub

    'Insertionsort
    Public Sub insertionWortUmlaut(ByRef Wort() As String)
        Dim tmp As String
        Dim i As Integer
        Dim j As Integer
